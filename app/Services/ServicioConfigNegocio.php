...
class ServicioConfigNegocio
{
    ...
    public function yapePaymentMessageWithTotal(float $total): string
    {
        ...
        if ($total > 0) {
            $base .= "\nMonto a pagar: S/".number_format($total, 0);
        }

        return $base."\n\nPor favor realiza el pago y envíanos la captura del comprobante 💖";
    }

    public function yapePaymentMessage(): string
    {
        return $this->yapePaymentMessageWithTotal(0);
    }
