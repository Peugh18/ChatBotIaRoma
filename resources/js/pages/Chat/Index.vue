            ...
            <div class="crm-chat-body">
                ...
                <div class="crm-chat-panel lg:col-span-3">
                        <div class="crm-chat-panel-header">
                            <h2 class="text-sm font-semibold uppercase tracking-wider text-foreground">Conversaciones</h2>
                            <span
                        ...
                        <div class="min-h-0 flex-1 space-y-5 overflow-y-auto overscroll-contain p-4 text-xs">
                            ...
                            <div class="border-t border-gray-100 pt-4 dark:border-gray-700">
                                ...
                                >
                                    ...
                                    <div v-if="salesContext.sales_stage" class="mt-1 text-[10px] text-gray-500">
                                        Etapa: {{ salesContext.sales_stage }}
                                    </div>
                                </div>
