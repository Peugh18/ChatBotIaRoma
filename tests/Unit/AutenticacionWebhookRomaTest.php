...
class AutenticacionWebhookRomaTest extends TestCase
{
    ...
    public function test_rejects_requests_without_valid_token(): void
    {
        ...
        $this->assertFalse(AutenticacionWebhookRoma::verify($request));
    }
    ...
    public function test_accepts_valid_bearer_token(): void
    {
        ...
        $this->assertTrue(AutenticacionWebhookRoma::verify($request));
    }
