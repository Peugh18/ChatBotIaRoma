...
use App\Services\CustomerDataSyncService;
use Illuminate\Foundation\Testing\RefreshDatabase;
use Tests\TestCase;

class CustomerDataSyncServiceTest extends TestCase
{
    use RefreshDatabase;

    private CustomerDataSyncService $syncService;

    protected function setUp(): void
    {
        parent::setUp();
        $this->syncService = app(CustomerDataSyncService::class);
    }
