...
class VectorSimilarityTest extends TestCase
{
    ...
    {
        $vector = [1.0, 0.0, 0.0];
        $similarity = VectorSimilarity::cosineSimilarity($vector, $vector);
    ...
    public function test_cosine_similarity_orthogonal_vectors()
    {
        $vectorA = [1.0, 0.0];
        $vectorB = [0.0, 1.0];
        $similarity = VectorSimilarity::cosineSimilarity($vectorA, $vectorB);
    ...
    public function test_top_k_similar()
    {
        ...
        $results = VectorSimilarity::topKSimilar($queryVector, $database, 2);
    ...
    public function test_filter_by_similarity()
    {
        ...
        $results = VectorSimilarity::filterBySimilarity($queryVector, $database, 0.72);
